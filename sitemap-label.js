...
function loadtoc(a)
{
  ...
  tocLoaded=true;
  displayToc2();
  document.write('</br><a href="https://idopen404.blogspot.co.id" style="font-size: 8px; text-decoration:none; color: #616469;">by Ahmad-ridha</a>')
}
...
function displayToc(a)
{
  ...
  var b=document.getElementById("toc");b.innerHTML=f+h
}
...
function hideToc()
{
  ...
  var b=document.getElementById("toclink");b.innerHTML='<a href="#" onclick="scroll(0,0); showToc(); Effect.toggle(\'toc-result\',\'blind\');">?? Menampilkan Daftar Isi</a> <img src="http://radiorodja.googlepages.com/new_1.gif"/>'
}
function looptemp2()
{
